...
!function(){var e={initialize:function(){var e=this;e.setUpListeners()},setUpListeners:function(){$("form").on("click",".feedback-block__offer-button",e.submitForm),$(".header-block__order-button").on("click",e.scrollToOrder),$(".header-block__info-button").on("click",e.scrollToDetails),$(".details-block__offer-button").on("click",e.scrollToMarket),$("form").on("keydown","input",e.removeError),$("#personalDataCheck").on("click",e.switchCalculatorChecked)},switchCalculatorChecked:function(){$("#personalDataCheck").attr("checked")?($("#personalDataCheck").attr("checked",!1),$("#personalDataBtn").addClass("disabled")):($("#personalDataCheck").attr("checked","checked"),$("#personalDataBtn").removeClass("disabled"))},removeError:function(){$(this).tooltip("destroy").parents(".form-group").removeClass("has-error")},scrollToMarket:function(e){e.preventDefault();var o=$(".market-block__section").offset().top;$("html, body").animate({scrollTop:o-0},800)},scrollToDetails:function(e){e.preventDefault();var o=$(".details-block").offset().top;$("html, body").animate({scrollTop:o-0},800)},scrollToOrder:function(e){e.preventDefault();var o=$(".feedback-block__background").offset().top;$("html, body").animate({scrollTop:o-0},800)},submitForm:function(o){o.preventDefault();var t=$("form"),a=$(".feedback-block__offer-button");if(e.validateForm(t)===!1)return!1;a.addClass("disabled");var r=t.serialize();$.ajax({url:"contact_form/contact_process.php",type:"POST",data:r}).done(function(e){if("OK"===e){var o="<div class='bg-success'>Спасибо за вашу заявку. Мы обязательно свяжемся с вами, в самое ближайшее время.</div>";$.each($(".form-group input"),function(){$(this).removeClass("has-success").val("")}),$("#valid").html(o)}else $("#valid").html(e)}).always(function(){a.removeClass("disabled")})},validateForm:function(e){var o=e.find("input"),t=!0;return o.tooltip("destroy"),$.each(o,function(e,o){var a=$(o),o=a.val(),r=a.parents(".form-group"),l=r.find("label").text(),s="",c=$(document).width(),n="";"ФИО"!==l&&(l=l.toLowerCase()),s="Введите "+l,n=768>c?"top":"left",0===o.length?(r.addClass("has-error").removeClass("has-success"),a.tooltip({trigger:"manual",placement:n,title:s}).tooltip("show"),t=!1):r.addClass("has-success").removeClass("has-error")}),t}};e.initialize()}();
