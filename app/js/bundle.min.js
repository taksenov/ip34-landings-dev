...
!function(){var o={initialize:function(){var o=this;o.setUpListeners()},setUpListeners:function(){$("form").on("click",".feedback-block__offer-button",o.submitForm),$(".header-block__order-button").on("click",o.scrollToOrder),$(".header-block__info-button").on("click",o.scrollToDetails),$(".details-block__offer-button").on("click",o.scrollToMarket),$("form").on("keydown","input",o.removeError)},removeError:function(){$(this).tooltip("destroy").parents(".form-group").removeClass("has-error")},scrollToMarket:function(o){o.preventDefault();var e=$(".market-block__section").offset().top;$("html, body").animate({scrollTop:e-0},800)},scrollToDetails:function(o){o.preventDefault();var e=$(".details-block").offset().top;$("html, body").animate({scrollTop:e-0},800)},scrollToOrder:function(o){o.preventDefault();var e=$(".feedback-block__background").offset().top;$("html, body").animate({scrollTop:e-0},800)},submitForm:function(e){e.preventDefault();var t=$("form"),r=$(".feedback-block__offer-button");if(o.validateForm(t)===!1)return!1;r.addClass("disabled");var a=t.serialize();$.ajax({url:"contact_form/contact_process.php",type:"POST",data:a}).done(function(o){if("OK"===o){var e="<div class='bg-success'>Спасибо за вашу заявку. Мы обязательно свяжемся с вами, в самое ближайшее время.</div>";$.each($(".form-group input"),function(){$(this).removeClass("has-success").val("")}),$("#valid").html(e)}else $("#valid").html(o)}).always(function(){r.removeClass("disabled")})},validateForm:function(o){var e=o.find("input"),t=!0;return e.tooltip("destroy"),$.each(e,function(o,e){var r=$(e),e=r.val(),a=r.parents(".form-group"),l=a.find("label").text(),s="",n=$(document).width(),i="";"ФИО"!==l&&(l=l.toLowerCase()),s="Введите "+l,i=768>n?"top":"left",0===e.length?(a.addClass("has-error").removeClass("has-success"),r.tooltip({trigger:"manual",placement:i,title:s}).tooltip("show"),t=!1):a.addClass("has-success").removeClass("has-error")}),t}};o.initialize()}();
